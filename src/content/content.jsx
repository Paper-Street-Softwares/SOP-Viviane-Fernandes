...
export const infos = {
  name: 'Dra. Viviane Fernandes',
  email: 'contato', // Email desejado pelo cliente
  emailSecundario: 'vivianefernandesadvocacia.com.br', // Email desejado pelo cliente
  domain: 'vivianefernandesadvocacia.com.br', // Sem "www"
  phone: {
    ddd: '11',
    firstPart: '98929', // Apenas os 5 primeiros números (incluindo o 9)
    secondPart: '1806', // Apenas os 4 últimos números
  },
  phoneSecundario: {
    ddd: 'A_Definir',
...
const content = {
  texts: {
    ...
    hero: {
      ...
      subtitle: (
        <p>
          Seja no Tributário, Empresarial ou na busca pelo seu Previdenciário.
          Meu foco é a segurança do seu patrimônio e futuro. <br /> Minha
          atuação é personalizada, porque cada direito é único.
        </p>
      ),
      ...
      ctaButtonText: 'Falar com a Advogada Especialista',
      ctaButtonTextSecondary: 'Agendar Horário',
      obsHero: {
        icon: <LucideIdCard />,
        iconTwo: <LucideIdCard />,
        text: 'Atendimento online para todo território nacional',
        textTwo: '',
      },
    ...
    about: {
      ...
      miniTag: 'Porque meus clientes confiam em mim',
      title: (
      ...
      paragraph: (
        <div>
          Com treze anos de vivência prática no ecossistema empresarial, minha
          atuação transcende o formalismo jurídico para oferecer uma consultoria
          verdadeiramente estratégica e orientada a resultados. Minha trajetória
          como mulher, mãe, avó e cristã moldou uma ética de trabalho baseada na
          responsabilidade e na proteção de legados, permitindo-me compreender
          as dores do empresário sob uma perspectiva de quem conhece o "chão de
          fábrica" dos negócios. Essa experiência é o que sustenta minha busca
          incessante pela excelência técnica, garantindo que cada decisão
          jurídica seja um alicerce para o crescimento sustentável do cliente.
        </div>
      ),
