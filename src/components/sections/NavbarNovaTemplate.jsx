        ...
        <div className="container mx-auto flex items-center m-auto max-w-[1215px] h-full w-[90%] justify-between py-2">
          <div
            className={`flex flex-col z-20 relative  ${
              isScrolled
                ? 'w-[50%] phone3:w-[40%] tablet2:w-[30%] desktop1:w-[15%] transition-all duration-700'
                : 'w-[200px] tablet1:w-[300px] desktop1:w-[250px] desktop3:w-[300px] transition-all duration-700'
            }`}
          >
            {' '}
            <img
                  ...
                  {labels.map((item, index) => (
                    <Link
                      ...
                      className={`cursor-pointer transition-all w-full ${
                        active === index ? 'text-white' : 'text-textPadrao'
                      }`}
                    >
                      {item}
                    </Link>
